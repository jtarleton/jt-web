...
<th class="sf_admin_text sf_admin_list_th_post_status">
  <?php if ('post_status' == $sort[0]): ?>
    <?php echo link_to(__('Post status', array(), 'messages'), '@jt_posts', array('query_string' => 'sort=post_status&sort_type='.($sort[1] == 'asc' ? 'desc' : 'asc'))) ?>
    <?php echo image_tag(sfConfig::get('sf_admin_module_web_dir').'/images/'.$sort[1].'.png', array('alt' => __($sort[1], array(), 'sf_admin'), 'title' => __($sort[1], array(), 'sf_admin'))) ?>
  <?php else: ?>
    <?php echo link_to(__('Post status', array(), 'messages'), '@jt_posts', array('query_string' => 'sort=post_status&sort_type=asc')) ?>
  <?php endif; ?>
</th>
<?php end_slot(); ?>
