...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/jt-web/log/front_test.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/jt-web/cache/front/test/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/jt-web/apps/front/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'session_path' => '/var/jt-web/cache/front/test/test/sessions',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/jt-web/cache/front/test/template',
  'lifetime' => 86400,
  'prefix' => '/var/jt-web/apps/front/template',
)));
