...
/**
 * JtZipcodesExpanded form base class.
 *
 * @method JtZipcodesExpanded getObject() Returns the current form's model object
 *
 * @package    jtweb
 * @subpackage form
 ...
 */
abstract class BaseJtZipcodesExpandedForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('jt_zipcodes_expanded[%s]');
