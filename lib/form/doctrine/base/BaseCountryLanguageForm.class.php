...
/**
 * CountryLanguage form base class.
 *
 * @method CountryLanguage getObject() Returns the current form's model object
 *
 * @package    jtweb
 * @subpackage form
 ...
 */
abstract class BaseCountryLanguageForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('country_language[%s]');
