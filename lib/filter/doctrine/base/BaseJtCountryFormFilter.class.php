...
/**
 * JtCountry filter form base class.
 *
 * @package    jtweb
 * @subpackage filter
 ...
 */
abstract class BaseJtCountryFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('jt_country_filters[%s]');
