...
/**
 * CountryLanguage filter form base class.
 *
 * @package    jtweb
 * @subpackage filter
 ...
 */
abstract class BaseCountryLanguageFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('country_language_filters[%s]');
