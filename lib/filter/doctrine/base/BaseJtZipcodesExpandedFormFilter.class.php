...
/**
 * JtZipcodesExpanded filter form base class.
 *
 * @package    jtweb
 * @subpackage filter
 ...
 */
abstract class BaseJtZipcodesExpandedFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('jt_zipcodes_expanded_filters[%s]');
