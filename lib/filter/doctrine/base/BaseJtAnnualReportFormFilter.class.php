...
/**
 * JtAnnualReport filter form base class.
 *
 * @package    jtweb
 * @subpackage filter
 ...
 */
abstract class BaseJtAnnualReportFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('jt_annual_report_filters[%s]');
